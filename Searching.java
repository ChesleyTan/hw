...
public class Searching {
	...
	return tPos;
	//	return !(a instanceof int || a instanceof String || a instanceof Binary || a instanceof Hexadecimal) ? -1 
	//	: a instanceof int ? linSearch (((int) a).linSearch((int) target))
	//	: a instanceof String ? linSearch (((String) a).linSearch((String) target))
	//	: a instanceof Binary ? linSearch (((Binary) a).linSearch((Binary) target))
	//	: a instanceof Hexadecimal ? linSearch (((Hexadecimal) a).linSearch((Hexadecimal) target))
	//	: -1;
